    ...
    <div class="top-slider__for">
        <div>
            <div class="top-slider__for--item"
                 style="background: url('img/jpeg_files/s-1.jpg') no-repeat center / cover"></div>
        </div>
        <div>
            <div class="top-slider__for--item"
                 style="background: url('img/jpeg_files/s-2.jpg') no-repeat center / cover;"></div>
        </div>
        <div>
            <div class="top-slider__for--item"
                 style="background: url('img/jpeg_files/s-1.jpg') no-repeat center / cover"></div>
        ...
        <div class="uk-flex uk-grid-width-small-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-3"
            ...
            <div>
                <div class="inform-list__item item-1">
                    ...
                    <a href="#" class="btn btn-link-arrow">Смотреть все</a>
                </div>
...
<section class="section-padding section-with-bg four-item-slider-block">
    <div class="container">
        <h2 class="title-h2 section-title-h2">Лидеры продаж</h2>
...
<section class="lookbook-main" style="background: url('img/jpeg_files/lookbook.jpg') no-repeat 50% 50% / cover">
    <div class="container">
        <div class="lookbook-main__content">
            <h2 class="lookbook-main__content--title">LookBook</h2> <br>
            <a href="#" class="btn btn-normal btn-inverse btn-hover-normal">смотреть детальнее</a>
        </div>
    </div>
</section>
...
<div class="section-padding section-with-bg--skew">
    <div class="container">
        <div class="uk-grid uk-grid-small uk-grid-width-1-1 uk-grid-width-large-1-2">
            ...
            <section class="news-main">
                <h3 class="title-h2 section-title-h2">Последние обзоры</h3>
                <div class="uk-grid uk-grid-small uk-grid-width-small-1-1 uk-grid-width-medium-1-2 uk-grid-width-large-1-2">
                    <div class="news-main-item">
                        <div class="news-main-item__date">
                            <time datetime="25/06" class="uk-hidden">25/06</time>
