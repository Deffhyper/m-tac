...
<div class="container">
                ...
                <div class="product-slider__top">
                    <div>
                        <div class="product-slider__top--item">
                            <a href="#product-gallery-window" data-uk-modal="{center:true}">
                                <img src="img/jpeg_files/prod-1.jpg" alt="" width="615" height="615">
                                <span class="product-zoom"><span
                                            class="iconmoon icon-zoom-in"></span> увеличить</span>
                            </a>
                        </div>
                    </div>
                    <div>
    ...
    <div class="product-wrapper-bottom">
        <div class="product-property">
            <div class="product-section left-block">
                <p class="product-property-title uk-text-uppercase">Характеристики товара</p>
                <table class="product-property-table">
                    ...
                    <tr>
                        ...
                        <td>Литьевой метод крепления, ППУ (пенополиуретан) двухкомпонентная система, производства
                            компании «Basf», Германия. Маслобензостойкая, температурный режим эксплуатации от -35С до
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            - стелька вкладная: кожа натуральная спилок (стелечный), КРС, толщина 2-3мм, производства
                            Украина<br>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="product-section right-block">
                <p class="product-property-title uk-text-uppercase">Описание</p>
                <p class="product-property-text">Комбинированные летние ботинки с высокой берцой Mk.4 от компании M-Tac.
        ...
        <div class="product-section">
            <p class="product-property-title uk-text-uppercase">Видеообзор</p>
            <iframe width="100%" height="660px" src="https://www.youtube.com/embed/ia4q0-8UJBg" frameborder="0"
                    allowfullscreen></iframe>
        </div>
        <div class="product-section">
            <p class="product-property-title uk-text-uppercase">Технологии</p>
        ...
        <div class="product-section">
            <p class="product-property-title uk-text-uppercase">Обзоры</p>
