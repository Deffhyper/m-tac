<div class="breadcrumbs__interactive"
     style="background: url('img/jpeg_files/breadcrumbs-interactive-back.jpg') no-repeat center / cover;">
    <div class="container">
        <div class="breadcrumbs-wrapper">
            <div class="breadcrumbs-left">
                <h1 class="breadcrumbs-title">Text</h1>
                <ul class="breadcrumbs-list list-inline" itemscope itemtype="http://schema.org/BreadcrumbList">
